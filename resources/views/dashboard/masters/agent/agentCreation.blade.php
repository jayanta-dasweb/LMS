...
@section('title', 'Agent Creation ')

@section('pageDescription', 'Create Agent for lead enquiry form')
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-5 fv-row">
                            ...
                            <input type="text" name="category_name" class="form-control mb-2"
                                placeholder="Name of the Agent" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6 mb-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="agent_name" class="form-control mb-2"
                                placeholder="Agent’s Company Name" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6 mb-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="email" name="email_id" class="form-control mb-2" placeholder="Agent’s Email ID"
                                value="" />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">An Email ID is required and recommended to be unique.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6 mb-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="tel" name="contact_number" class="form-control mb-2"
                                placeholder="Agent’s Contact Number" value="" />
                            <!--end::Input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">A Contact Number is required and recommended to be unique.</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6 mb-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="agent_designation" class="form-control mb-2"
                                placeholder="Agent’s Designation" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6 mb-5">
                            <!--begin::Label-->
                            <label class="required form-label">Communication Address</label>
                            <!--end::Label-->
                            <!--begin::Input-->
                            <textarea name="communication_address" class="form-control" style="height: 17px;"
                                placeholder="Agent’s Communication Address"></textarea>
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6 mb-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="agent_city" class="form-control mb-2" placeholder="Agent’s City"
                                value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="col-md-6 mb-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="agent_country" class="form-control mb-2"
                                placeholder="Agent’s Country" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6 mb-5">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="agent_pincode" class="form-control mb-2"
                                placeholder="Agent’s Pincode" value="" />
                            <!--end::Input-->
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                        <div class="col-md-6">
                            ...
                            <!--end::Select2-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set a Agent active / deactivate</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Input group-->
                    </div>
